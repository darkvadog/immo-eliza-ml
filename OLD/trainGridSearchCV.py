...
def train():
    ...
    learning_rate=0.1,      # how much each new tree contributes to the overall model where lower values lead to slower learning but potentially better generalization
    max_iter=100,
    max_depth=3,
    loss="squared_error",
